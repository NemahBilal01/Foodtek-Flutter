...
class CheeseburgerDetailsScreen extends StatefulWidget {
  ...
  @override
  State<CheeseburgerDetailsScreen> createState() =>
      _CheeseburgerDetailsScreenState();
}
    ...
    return CommonLayoutWithoutfilterclips(
      ...
      child: Column(
        ...
        children: [
                        ...
                        SizedBox(
                          ...
                          child: SliderTheme(
                            data: SliderThemeData(
                              trackHeight: 8,
                              trackShape:
                                  RoundedRectSliderTrackShape(radius: 10),
          ...
          Padding(
            padding:
                const EdgeInsets.only(top: 10, left: 24, bottom: 10, right: 24),
              ...
              onPressed: () async {
                try {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => CartAndHistoryScreen()),
                  );
                } catch (e) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                        content: Text('Failed added to cart: ${e.toString()}')),
                  );
                }
              },
