...
//       Provider.of<OrderProvider>(context, listen: false).loadUserOrders(30);
//     });
//   }
//
//   @override
...
//           : _buildOrderList(context, orderHistory),
//     );
//   }
//
...
//               child: TextButton(
//                 onPressed: () {
//                   // يمكنك تنفيذ تحميل المزيد هنا إذا كنت تدعم الـ pagination
//                 },
//                 child: Text(
...
//                           color: Color(0XFF25AE4B), size: 18),
//                       SizedBox(width: 4),
//                       Text(
...
//   }
//
//   void _reorder(BuildContext context, List<CartItemModel> items) {
//     final cartProvider = context.read<CartProvider>();
//     for (var item in items) {
//       cartProvider.addToCart(item.toMap());
//     }
...
class HistoryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: orderHistory.isEmpty
          ? _buildEmptyState(context)
          : _buildOrderList(orderHistory.cast<Map<String, dynamic>>()),
    );
  }
